...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MSX");
    case mBTC: return QString("mMSX");
    case uBTC: return QString::fromUtf8("μMSX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MonsterChains"));
    case mBTC: return QString(QObject::tr("Milli-MonsterChains (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MonsterChains (1 / 1,000,000)"));
    default: return QString("???");
    }
}
