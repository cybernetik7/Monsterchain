MonsterChain-qt: Qt4 GUI for MonsterChain
===============================
...
Alternatively, install Qt Creator and open the `MonsterChain-qt.pro` file.

An executable named `MonsterChain-qt` will be built.
...
A warning for people using the *static binary* version of MonsterChain on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of MonsterChain is linked against libdb5.3.
...
installed causes MonsterChain-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
